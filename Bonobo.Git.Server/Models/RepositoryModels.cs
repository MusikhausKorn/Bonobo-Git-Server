...
namespace Bonobo.Git.Server.Models
{
    ...
    public class RepositoryTreeDetailModel
    {
        ...
        public string CommitDateString { get { return CommitDate.HasValue ? CommitDate.Value.ToString(Configuration.AppSettings.StandardDateTimeFormat) : CommitDate.ToString(); } }
